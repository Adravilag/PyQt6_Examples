...
class FutureAlternativeMapExample(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Future Alternative Map Example")
        self.resize(300, 150)
...
if __name__ == '__main__':
    ...
    window = FutureAlternativeMapExample()
    window.show()
    sys.exit(app.exec())
